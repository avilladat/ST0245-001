...
Date: 18/06/2020
Code Version: 1
Availability: https://github.com/mauriciotoro/ST0245-Eafit/blob/master/laboratorios/lab03/spoiler/ejercicio-1.1/java/LectorDatos.java
*/
        ...
        try{
            ...
            while((line = b.readLine()) != null) {
                if(lineCount != 0) {
                    ...
                    Triplet<Long, Long, Double> a = new Triplet<Long, Long, Double>(source, destination, distance);
                    edges.add(a);
                }
                lineCount++;
            }
