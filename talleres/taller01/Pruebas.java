    ...
    public void test(){
        ...
        while(opc!=5){
            ...
            switch(opc){
                ...
                int opc3 = menu3();
                while(opc3!=8){
                    if(opc3!=1 && opc3!=2 && opc3!=3 && opc3!=4 && opc3!=5 && opc3!=6 && opc3!=7 && opc3!=8)
                        System.out.println("Opción no valida");
                    switch (opc3) {
                        case 1:
                        ...
                        System.out.println("El radio polar del punto es: "+p3d.radio());
                            break;
                        case 5:
                        System.out.println("El angulo polar del punto es: "+Math.toDegrees(p3d.anguloPolar()));
                            break;
                        case 6:
                        System.out.println("El angulo acimut del punto es: "+Math.toDegrees(p3d.anguloAcimut()));   
                            break;
                        case 7:
                        System.out.println("Ingrese abscisa");
                        ...
                        System.out.println("La distancia euclidiana entre los puntos es: "+p3d.distancia(new Punto3D(x3d2, y3d2, z3d2)));
                            break;
                        default:
                            break;
                    }
